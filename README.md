...
- [Jamie Wilson API script](https://www.example.com) - I built in his script into my project to be able to store and submit form data in google sheets.
- [Webdev simplified YouTube](https://www.example.com) - This video on regex explained what each carachters in a regex mean and after watching and learning this vide I was able to create a simple regex for email validation.
